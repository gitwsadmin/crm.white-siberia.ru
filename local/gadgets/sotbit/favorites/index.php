...
<?endforeach?>
    ...
    <div id="gdfavoriteslink<?=$rnd?>" class="widget_links_btns gdfavaddlink">
        <a class="main-link b2b-main-link" href="javascript:void(0)" onclick="return ShowHide<?=$rnd?>(true);"><?echo GetMessage("GD_FAVORITES_ADD")?></a><span> | </span>
        <a class="main-link b2b-main-link" href="javascript:void(0)" onclick="return EditMode<?=$rnd?>(true);"><?echo GetMessage("GD_FAVORITES_CH")?></a>
    </div>
