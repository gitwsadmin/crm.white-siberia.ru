...
if(Loader::includeModule('sotbit.b2bcabinet') && $idUser > 0)
{
    ...
    <div class="wait_pay">
        ...
        <div class="widget_button_wrapper">
            <a href="<?=$order->getUrl($arParams['G_BUYORDER_PATH_TO_ORDER_DETAIL'])?>" class="btn btn_b2b widget_button">
            ...
            {
                ?>
                <a href="<?=$pathToDownload?>" class="btn btn_b2b widget_button">
