...
<?if($arParams["PERMISSION"]>"R"):?>
<div class="widget_links_btns" style="padding-top: 10px;"><a class="main-link b2b-main-link" href="<?=$GLOBALS["APPLICATION"]->GetCurPageParam("gdhtml=".$id."&edit=true", array("gdhtml", "edit"))?>"><?echo GetMessage("GD_HTML_AREA_CHANGE_LINK")?></a></div>
<?endif?>
