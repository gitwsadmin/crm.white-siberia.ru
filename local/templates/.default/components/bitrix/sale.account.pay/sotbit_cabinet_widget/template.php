...
else
{
	if ($arParams['REFRESHED_COMPONENT_MODE'] === 'Y')
	{
		...
		?>
            ...
            <div class="widget_content widget-private_invoices_content">
                ...
                <div class="widget-private_invoices-input">
                    <input type="text" class="form-control sale-acountpay-input" placeholder="0.00">
                    <div class="widget_button_wrapper">
                        <button type="button" class="btn btn-light widget_button send_invoices">
		...
		?>
        <div id="b2b_accountpay_vidget_component" style="display: none;">
            <?=JSON::encode($javascriptParams)?>
        </div>
